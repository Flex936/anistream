<script lang="ts">
    ...
    let {
        ...
        SelectedSub,
        SelectedAudio,
        OnTrackChange, // Swapped from OnChangeCommand
    } = $props();
...
>
    {#if SettingsView === "main"}
        ...
        >
            <span class="mr-1"><Captions size={20} /></span><span
                >Subtitles</span
        ...
        >
            <span class="mr-1"><AudioLines size={20} /></span><span
                >Audio Tracks</span
            ><span class="absolute right-7 text-gray-700"
    ...
    {:else if SettingsView === "subs"}
        ...
        <div
            class="max-h-48 overflow-y-auto flex flex-col gap-1 custom-scrollbar"
        >
            <button
