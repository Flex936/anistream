...
class _TheaterSettingsMenuState extends State<TheaterSettingsMenu> {
  ...
  void initState() {
    ...
    _tracksSub = widget.player.stream.tracks.listen((t) => setState(() => _tracks = t));
    _trackSub = widget.player.stream.track.listen((t) => setState(() {
      ...
      children: [
        ...
        Flexible(
          child: SingleChildScrollView(
            child: Column(
              children: _tracks.subtitle.map((t) => _TrackTile(
    ...
    return Column(
      ...
      children: [
        ...
        Flexible(
          child: SingleChildScrollView(
            child: Column(
              children: _tracks.audio.map((t) => _TrackTile(
