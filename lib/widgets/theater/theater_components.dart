  ...
  Widget build(BuildContext context) {
    return ClipRRect(
      ...
      child: BackdropFilter(
        ...
        child: Material(
          // ── FIXED: Dark translucent background ensures white icon is always visible ──
...
class TheaterLoadingOverlay extends StatelessWidget {
  ...
  const TheaterLoadingOverlay({super.key, required this.episode, required this.torrent, required this.controller});
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 32),
            Text(controller.statusText, style: const TextStyle(color: AppPalette.primary, fontSize: 14, fontWeight: FontWeight.w500)),
          ],
        ),
      ),
    );
