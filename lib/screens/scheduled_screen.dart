...
class _ScheduledScreenState extends State<ScheduledScreen> {
  ...
  Map<String, List<Anime>> _buildCalendar(List<Anime> anime) {
    ...
    for (final item in active) {
      ...
      // Dart weekday: 1 = Monday … 7 = Sunday  →  array index 0 … 6
  ...
  Widget _buildGrid(Map<String, List<Anime>> calendar) {
    final todayIndex = _now.weekday - 1; // 0 = Monday … 6 = Sunday
...
//  _DayColumn
//
//  No internal scroll — grows to fit all its cards so the outer
//  SingleChildScrollView handles the vertical scroll for the whole page.
// ════════════════════════════════════════════════════════════════════════════
